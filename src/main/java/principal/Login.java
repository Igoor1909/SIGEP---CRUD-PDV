...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbxMostrarSenha.setBackground(new java.awt.Color(0, 204, 204));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(txtSenha, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    public void LogarUsuario() {
        if (this.dao == null) {
            this.dao = new usuarioDAO(); // Garante que dao nunca será null
        }
        ...
        try {
            ...
            // Usa o DAO injetado ou instanciado
            ResultSet rsUsuarioDao = dao.autenticacaoUsuario(usrDados);

            if (rsUsuarioDao.next()) {
                String tipoUsuario = rsUsuarioDao.getString("tipo_usuario");

                if ("ADMINISTRADOR".equalsIgnoreCase(tipoUsuario)) {
                    new Principal().setVisible(true);
                } else if ("ATENDENTE".equalsIgnoreCase(tipoUsuario)) {
                    new Pedido().setVisible(true);
                } else {
                    new Principal().setVisible(true); // Default
                }
